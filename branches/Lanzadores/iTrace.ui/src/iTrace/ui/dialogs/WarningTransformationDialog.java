...
public class WarningTransformationDialog extends AbstractDetailsDialog {
	private final String details;

	public WarningTransformationDialog(Shell parentShell, String title,
	         Image image, String message, String details)
	   {
	      this(new SameShellProvider(parentShell), title, image, message,
	            details);
	   }
	   public WarningTransformationDialog(IShellProvider parentShell,
