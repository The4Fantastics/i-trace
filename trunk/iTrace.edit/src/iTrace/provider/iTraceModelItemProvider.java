 ...
 * @generated
 */
public class iTraceModelItemProvider
	 ...
	 * @generated
	 */
	public iTraceModelItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ITracePackage.Literals.ITRACE_MODEL__ARTEFACTS);
			childrenFeatures.add(ITracePackage.Literals.ITRACE_MODEL__SPECIFIC_FEATURES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(iTraceModel.class)) {
			...
			case ITracePackage.ITRACE_MODEL__SPECIFIC_FEATURES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ITracePackage.Literals.ITRACE_MODEL__SPECIFIC_FEATURES,
				 ITraceFactory.eINSTANCE.createSpecificFeature()));
	}
